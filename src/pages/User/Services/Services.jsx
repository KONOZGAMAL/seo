            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                <div class="right-content">
                  ...
                  <p>Using Agile techniques to deliver value to your customers faster</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                <div class="right-content">
                  ...
                  <p>Supporting the design of innovative technology solutions to give you a competitive edge in the digital age</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                <div class="right-content">
                  ...
                  <p>Using data to drive improved decision-making within your business</p>
                </div>
              </div>
            </div>
          </div>
